...
public class VernisajPage4 extends Fragment {

    private static VernisajPage4 INSTANCE = null;
    ...
    public VernisajPage4(){
    }

    public static VernisajPage4 getINSTANCE(){
        if (INSTANCE == null)
            INSTANCE = new VernisajPage4();
        return INSTANCE;
    }
